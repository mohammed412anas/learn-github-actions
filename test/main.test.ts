...
describe("test suit of main.ts module",()=>{
    ...
    test("should take first prompt value as 9 and perform mathematical calculation of invalid expression '10 + 30 * (4 ^ 2) - sqrt(49'<-- missed a paranthesis here and return result as 0",()=>{
        mockedPrompt
            .mockReturnValueOnce("9")
            .mockReturnValueOnce("10 + 30 * (4 ^ 2) - sqrt(49")
            .mockReturnValueOnce("exit");
